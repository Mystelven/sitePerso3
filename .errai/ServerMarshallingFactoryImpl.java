...
@Dependent public class ServerMarshallingFactoryImpl implements MarshallerFactory {
  ...
  @Inject @ObserverModel @Server private Event<CapitalsSelected> var3;
  ...
  private Marshaller<Capital> org_jboss_demo_widgets_client_shared_Capital;
  ...
  private Marshaller<CapitalsSelected> org_jboss_demo_widgets_client_shared_CapitalsSelected;
  ...
  public ServerMarshallingFactoryImpl() {
    ...
    org_jboss_demo_widgets_client_shared_Capital = new Marshaller<Capital>() {
      private Capital[] EMPTY_ARRAY = new Capital[0];
      public Capital[] getEmptyArray() {
        return EMPTY_ARRAY;
      }
      public Class getTypeHandled() {
        return Capital.class;
      }
      public Capital demarshall(EJValue a0, MarshallingSession a1) {
        try {
          if (a0.isNull()) {
            return null;
          }
          ...
          String objId = obj.get("^ObjectID").isString().stringValue();
          if (a1.hasObject(objId)) {
            return a1.getObject(Capital.class, objId);
          }
          ...
          if ((obj.containsKey("state")) && (!obj.get("state").isNull())) {
            entity.setState(java_lang_String.demarshall(obj.get("state"), a1));
          }
          if ((obj.containsKey("timeZone")) && (!obj.get("timeZone").isNull())) {
            entity.setTimeZone(java_lang_String.demarshall(obj.get("timeZone"), a1));
          }
          return entity;
        } catch (Throwable t) {
          t.printStackTrace();
          throw new RuntimeException("error demarshalling entity: org.jboss.demo.widgets.client.shared.Capital", t);
        }
      }
      public String marshall(Capital a0, MarshallingSession a1) {
        if (a0 == null) {
          return "null";
        }
        if (a1.hasObject(a0)) {
          String objId = a1.getObject(a0);
          return new StringBuilder(128).append("{\"^EncodedType\":\"org.jboss.demo.widgets.client.shared.Capital\"").append(",").append("\"^ObjectID\":\"").append(objId).append("\"}").toString();
        }
        String objId = a1.getObject(a0);
        a1.recordObject(objId, objId);
        return new StringBuilder(512).append("{\"^EncodedType\":\"org.jboss.demo.widgets.client.shared.Capital\",\"^ObjectID\":\"").append(objId).append("\"").append(",").append("\"name\" : ").append(java_lang_String.marshall(a0.getName(), a1)).append(",").append("\"state\" : ").append(java_lang_String.marshall(a0.getState(), a1)).append(",").append("\"timeZone\" : ").append(java_lang_String.marshall(a0.getTimeZone(), a1)).append("}").toString();
      }
    };
    marshallers.put("org.jboss.demo.widgets.client.shared.Capital", org_jboss_demo_widgets_client_shared_Capital);
    ...
    org_jboss_demo_widgets_client_shared_CapitalsSelected = new Marshaller<CapitalsSelected>() {
      private CapitalsSelected[] EMPTY_ARRAY = new CapitalsSelected[0];
      public CapitalsSelected[] getEmptyArray() {
        return EMPTY_ARRAY;
      }
      public Class getTypeHandled() {
        return CapitalsSelected.class;
      }
      public CapitalsSelected demarshall(EJValue a0, MarshallingSession a1) {
        try {
          if (a0.isNull()) {
            return null;
          }
          ...
          String objId = obj.get("^ObjectID").isString().stringValue();
          if (a1.hasObject(objId)) {
            return a1.getObject(CapitalsSelected.class, objId);
          }
          CapitalsSelected entity = new CapitalsSelected(java_util_List.demarshall(obj.get("selectedCapitals"), a1));
          a1.recordObject(objId, entity);
          return entity;
        } catch (Throwable t) {
          t.printStackTrace();
          throw new RuntimeException("error demarshalling entity: org.jboss.demo.widgets.client.shared.CapitalsSelected", t);
        }
      }
      public String marshall(CapitalsSelected a0, MarshallingSession a1) {
        if (a0 == null) {
          return "null";
        }
        if (a1.hasObject(a0)) {
          String objId = a1.getObject(a0);
          return new StringBuilder(128).append("{\"^EncodedType\":\"org.jboss.demo.widgets.client.shared.CapitalsSelected\"").append(",").append("\"^ObjectID\":\"").append(objId).append("\"}").toString();
        }
        String objId = a1.getObject(a0);
        a1.recordObject(objId, objId);
        return new StringBuilder(256).append("{\"^EncodedType\":\"org.jboss.demo.widgets.client.shared.CapitalsSelected\",\"^ObjectID\":\"").append(objId).append("\"").append(",").append("\"selectedCapitals\" : ").append(java_util_List.marshall(a0.getSelectedCapitals(), a1)).append("}").toString();
      }
    };
    marshallers.put("org.jboss.demo.widgets.client.shared.CapitalsSelected", org_jboss_demo_widgets_client_shared_CapitalsSelected);
